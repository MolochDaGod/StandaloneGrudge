        ...
        <div style={{ background: 'rgba(20,26,43,0.8)', border: '1px solid var(--border)', borderRadius: 14, padding: 20 }}>
          <div style={{ textAlign: 'center', marginBottom: 20 }}>
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: 8 }}>
              <SpriteAnimation spriteData={getPlayerSprite(playerClass, playerRace, activeHero?.namedHeroId)} animation="idle" scale={4 * getRaceHeightScale(playerRace)} speed={150} containerless={false} />
            </div>
