...
/**
 * HeroCreate — Redirect stub
 * Hero recruitment has been consolidated into Grudge Builder.
 * This component shows a brief transition screen and redirects.
 *
 * Original preserved in HeroCreate.LEGACY.jsx
 */
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div className="font-cinzel" style={{
          ...
          Opening Hero Builder
        </div>

        <div style={{
          fontSize: '0.85rem', color: 'rgba(255,255,255,0.5)', marginBottom: 20,
        }}>
          Hero recruitment has moved to Grudge Builder.
