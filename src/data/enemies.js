...
export const locations = [
  ...
  },
  {
    ...
    levelRange: [3, 5],
    enemies: ['wolf', 'goblin', 'skeleton', 'mushroom', 'flying_eye', 'shadow_bat', 'imp', 'giant_fly', 'twig_blight'],
  ...
  },
  {
    ...
    levelRange: [3, 5],
    enemies: ['goblin', 'skeleton', 'flying_eye', 'shadow_bat', 'mimic', 'mimic_chest', 'giant_fly', 'mine_amphibian'],
  ...
  },
  {
    ...
    levelRange: [5, 7],
    enemies: ['skeleton', 'dark_mage', 'wolf', 'mushroom', 'flying_eye', 'shadow_bat', 'twig_blight'],
  ...
  },
  {
    ...
    levelRange: [6, 9],
    enemies: ['skeleton', 'dark_mage', 'skeleton_knight', 'mimic', 'crow_knight', 'dark_knight', 'shadow_warrior', 'mimic_chest'],
  ...
  },
  {
    ...
    levelRange: [7, 9],
    enemies: ['skeleton', 'goblin', 'orc', 'skeleton_knight', 'mimic', 'stone_guardian', 'water_priestess_mage', 'ice_elemental', 'mimic_chest', 'mine_elemental', 'mine_arachnid'],
  ...
  },
  {
    ...
    levelRange: [8, 11],
    enemies: ['orc', 'skeleton', 'dark_mage', 'stone_guardian', 'crow_knight', 'dark_knight', 'fire_elemental'],
  ...
  },
  {
    ...
    levelRange: [10, 13],
    enemies: ['orc', 'skeleton', 'dark_mage', 'shadow_bat', 'water_priestess_mage', 'ice_elemental'],
  ...
  },
  {
    ...
    levelRange: [12, 15],
    enemies: ['dark_mage', 'orc', 'skeleton', 'mushroom', 'flying_eye', 'shadow_bat', 'crow_knight', 'twig_blight'],
  ...
  },
  {
    ...
    levelRange: [14, 16],
    enemies: ['dark_mage', 'skeleton', 'orc', 'mushroom', 'skeleton_knight', 'imp', 'mine_arachnid', 'mine_amphibian'],
  ...
  },
  {
    ...
    levelRange: [15, 18],
    enemies: ['dark_mage', 'dragon_whelp', 'orc', 'skeleton_knight', 'crow_knight', 'imp', 'fire_worm', 'demon_minion1', 'demon_minion2'],
