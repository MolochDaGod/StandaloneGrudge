...
export const enemyTemplates = {
  ...
  god_odin: {
    name: 'Odin, The Allfather', icon: '⚡', color: '#fbbf24',
    ...
    faction: 'crusade',
    abilities: [
      { id: 'gungnir', name: 'Gungnir', icon: '🔱', type: 'physical', damage: 2.2, description: 'Hurls the divine spear Gungnir' },
      { id: 'thunderclap', name: 'Thunderclap', icon: '⚡', type: 'magical', damage: 3.8, cooldown: 4, description: 'Lightning crashes down from the heavens' },
      { id: 'divine_shield', name: 'Divine Shield', icon: '🛡️', type: 'buff', damage: 0, cooldown: 6, description: 'An impenetrable divine barrier', effect: { stat: 'defense', flat: 80, duration: 3 } },
      { id: 'wisdom_sight', name: 'Wisdom of the Ages', icon: '👁️', type: 'buff', damage: 0, cooldown: 7, description: 'Sees all weaknesses, boosting damage', effect: { stat: 'damage', multiplier: 2.2, duration: 3 } },
      { id: 'valkyrie_storm', name: 'Valkyrie Storm', icon: '⚔️', type: 'magical', damage: 4.5, cooldown: 6, description: 'Summons a storm of divine warriors' },
      { id: 'ragnarok', name: 'Ragnarok', icon: '🌋', type: 'magical', damage: 5.0, cooldown: 8, description: 'Unleashes the end of all things' },
      { id: 'divine_heal', name: 'Divine Restoration', icon: '✨', type: 'heal', damage: 0, cooldown: 5, description: 'Restores vitality through divine power', healPercent: 0.15 },
      { id: 'time_freeze', name: 'Temporal Halt', icon: '⏳', type: 'magical', damage: 0.8, cooldown: 5, description: 'Freezes a hero outside of time', effect: { type: 'stun', duration: 2 } },
    ]
  },
  god_madra: {
    name: 'Madra, The Devourer', icon: '🩸', color: '#dc2626',
    ...
    faction: 'legion',
    abilities: [
      { id: 'blood_rend', name: 'Blood Rend', icon: '🩸', type: 'physical', damage: 2.0, description: 'Tears flesh with claws of blood' },
      { id: 'soul_devour', name: 'Soul Devour', icon: '💀', type: 'magical', damage: 3.5, cooldown: 4, description: 'Consumes a hero\'s soul energy', drainPercent: 0.5 },
      { id: 'corruption_aura', name: 'Corruption Aura', icon: '☠️', type: 'magical', damage: 1.5, cooldown: 3, description: 'Radiates corrupting energy', effect: { type: 'dot', damage: 0.18, duration: 4 } },
      { id: 'blood_frenzy', name: 'Blood Frenzy', icon: '😤', type: 'buff', damage: 0, cooldown: 6, description: 'Enters a blood-mad frenzy', effect: { stat: 'damage', multiplier: 2.5, duration: 3 } },
      { id: 'death_grip', name: 'Death Grip', icon: '✊', type: 'magical', damage: 1.2, cooldown: 5, description: 'Grips a hero with deathly force', effect: { type: 'stun', duration: 2 } },
      { id: 'apocalypse', name: 'Apocalypse', icon: '💥', type: 'magical', damage: 5.5, cooldown: 8, description: 'Brings forth total annihilation' },
      { id: 'vampiric_feast', name: 'Vampiric Feast', icon: '🧛', type: 'heal', damage: 0, cooldown: 5, description: 'Feasts on blood to heal wounds', healPercent: 0.18 },
      { id: 'plague_wave', name: 'Plague Wave', icon: '🦠', type: 'magical', damage: 2.8, cooldown: 5, description: 'A wave of plague washes over all' },
    ]
  },
  god_omni: {
    name: 'The Omni, Weaver of Fate', icon: '🌟', color: '#a78bfa',
    ...
    faction: 'fabled',
    abilities: [
      { id: 'arcane_blast', name: 'Arcane Blast', icon: '🌟', type: 'magical', damage: 2.0, description: 'A blast of pure arcane energy' },
      { id: 'fate_weave', name: 'Fate Weave', icon: '🕸️', type: 'magical', damage: 3.2, cooldown: 4, description: 'Rewrites fate to deal massive damage' },
      { id: 'cosmic_barrier', name: 'Cosmic Barrier', icon: '🛡️', type: 'buff', damage: 0, cooldown: 5, description: 'A barrier woven from starlight', effect: { stat: 'defense', flat: 70, duration: 3 } },
      { id: 'time_warp', name: 'Time Warp', icon: '⏰', type: 'magical', damage: 1.0, cooldown: 5, description: 'Warps time around a hero', effect: { type: 'stun', duration: 2 } },
      { id: 'stellar_rain', name: 'Stellar Rain', icon: '🌠', type: 'magical', damage: 4.8, cooldown: 6, description: 'Stars fall from the heavens' },
      { id: 'genesis', name: 'Genesis', icon: '💫', type: 'magical', damage: 5.5, cooldown: 9, description: 'Unmakes and remakes reality itself' },
      { id: 'cosmic_heal', name: 'Cosmic Restoration', icon: '💜', type: 'heal', damage: 0, cooldown: 5, description: 'Draws healing from the cosmic weave', healPercent: 0.14 },
      { id: 'mind_shatter', name: 'Mind Shatter', icon: '🧠', type: 'magical', damage: 2.5, cooldown: 4, description: 'Shatters the mind with psychic force', effect: { type: 'dot', damage: 0.20, duration: 3 } },
    ]
  },
  water_elemental: {
  ...
  flying_eye: {
    name: 'Flying Eye', icon: '👁️', color: '#e879f9',
    baseHealth: 70, baseDamage: 16, baseDefense: 4, baseMana: 40,
    xpReward: 14, goldReward: 7, speed: 19,
    abilities: [
      { id: 'eye_beam', name: 'Eye Beam', icon: '👁️', type: 'magical', damage: 1.2, description: 'A focused beam of dark energy' },
      { id: 'dive_attack', name: 'Dive Attack', icon: '💨', type: 'physical', damage: 1.6, cooldown: 3, description: 'Dives down with blinding speed' },
    ]
  },
  mushroom: {
    name: 'Poison Mushroom', icon: '🍄', color: '#a3e635',
    baseHealth: 90, baseDamage: 10, baseDefense: 8, baseMana: 60,
    xpReward: 13, goldReward: 6, speed: 8,
    abilities: [
      { id: 'spore_slap', name: 'Spore Slap', icon: '🍄', type: 'physical', damage: 0.9, description: 'A slap with a mushroom cap' },
      { id: 'toxic_spore', name: 'Toxic Spore', icon: '☠️', type: 'magical', damage: 0.6, cooldown: 3, description: 'Releases toxic spores that poison', effect: { type: 'dot', damage: 0.10, duration: 3 } },
    ]
  },
  skeleton_knight: {
    name: 'Skeleton Knight', icon: '💀', color: '#a1a1aa',
    baseHealth: 160, baseDamage: 22, baseDefense: 20, baseMana: 0,
    xpReward: 28, goldReward: 15, speed: 9,
    abilities: [
      { id: 'sword_slash', name: 'Sword Slash', icon: '⚔️', type: 'physical', damage: 1.2, description: 'A heavy sword slash' },
      { id: 'shield_wall', name: 'Shield Wall', icon: '🛡️', type: 'buff', damage: 0, cooldown: 4, description: 'Raises shield to block attacks', effect: { stat: 'defense', flat: 25, duration: 2 } },
      { id: 'bone_breaker', name: 'Bone Breaker', icon: '💀', type: 'physical', damage: 2.0, cooldown: 4, description: 'A devastating overhead strike' },
    ]
  },
  shadow_bat: {
    name: 'Shadow Bat', icon: '🦇', color: '#7c3aed',
    baseHealth: 55, baseDamage: 14, baseDefense: 3, baseMana: 30,
    xpReward: 12, goldReward: 5, speed: 22,
    abilities: [
      { id: 'wing_slash', name: 'Wing Slash', icon: '🦇', type: 'physical', damage: 0.9, description: 'Slashes with razor-sharp wings' },
      { id: 'sonic_screech', name: 'Sonic Screech', icon: '🔊', type: 'magical', damage: 1.4, cooldown: 3, description: 'A disorienting screech that rattles the mind', effect: { type: 'dot', damage: 0.08, duration: 2 } },
      { id: 'blood_drain', name: 'Blood Drain', icon: '🩸', type: 'physical', damage: 1.1, cooldown: 4, description: 'Latches on and drains blood to heal', drainPercent: 0.6 },
    ]
  },
  imp: {
    name: 'Cave Imp', icon: '👿', color: '#16a34a',
    baseHealth: 65, baseDamage: 11, baseDefense: 4, baseMana: 50,
    xpReward: 13, goldReward: 7, speed: 17,
    abilities: [
      { id: 'imp_scratch', name: 'Imp Scratch', icon: '👿', type: 'physical', damage: 0.8, description: 'Quick claws rake across flesh' },
      { id: 'hex_bolt', name: 'Hex Bolt', icon: '🔮', type: 'magical', damage: 1.5, cooldown: 3, description: 'A cursed bolt that weakens the target', effect: { stat: 'defense', flat: -10, duration: 2 } },
      { id: 'imp_frenzy', name: 'Imp Frenzy', icon: '😤', type: 'buff', damage: 0, cooldown: 5, description: 'Enters a wild frenzy, boosting speed and damage', effect: { stat: 'damage', multiplier: 1.5, duration: 2 } },
    ]
  },
  mimic: {
    name: 'Mimic', icon: '📦', color: '#b45309',
    baseHealth: 200, baseDamage: 26, baseDefense: 22, baseMana: 80,
    xpReward: 40, goldReward: 35, speed: 7,
    abilities: [
      { id: 'jaw_snap', name: 'Jaw Snap', icon: '👄', type: 'physical', damage: 1.3, description: 'Enormous jaws snap shut on the target' },
      { id: 'tongue_lash', name: 'Tongue Lash', icon: '👅', type: 'physical', damage: 1.8, cooldown: 3, description: 'A whip-like tongue lashes out with stunning force', effect: { type: 'stun', duration: 1 } },
      { id: 'devour_gold', name: 'Devour Gold', icon: '💰', type: 'physical', damage: 2.2, cooldown: 4, description: 'Bites hard and steals gold from the hero' },
      { id: 'iron_shell', name: 'Iron Shell', icon: '🛡️', type: 'buff', damage: 0, cooldown: 5, description: 'Retreats into its chest form, hardening its shell', effect: { stat: 'defense', flat: 35, duration: 3 } },
    ]
  },
  crow_knight: {
    name: 'Crow Knight', icon: '🐦‍⬛', color: '#1e293b',
    baseHealth: 170, baseDamage: 24, baseDefense: 16, baseMana: 40,
    xpReward: 32, goldReward: 18, speed: 16,
    abilities: [
      { id: 'talon_strike', name: 'Talon Strike', icon: '🗡️', type: 'physical', damage: 1.1, description: 'A swift blade slash guided by predator instinct' },
      { id: 'dive_bomb', name: 'Dive Bomb', icon: '💨', type: 'physical', damage: 2.2, cooldown: 3, description: 'Launches skyward and crashes down with devastating force' },
      { id: 'murder_flock', name: 'Murder of Crows', icon: '🐦', type: 'magical', damage: 1.4, cooldown: 4, description: 'Summons a swarm of crows that peck and blind', effect: { type: 'dot', damage: 0.12, duration: 3 } },
      { id: 'shadow_feint', name: 'Shadow Feint', icon: '🌑', type: 'buff', damage: 0, cooldown: 5, description: 'Blends with shadows, greatly increasing evasion', effect: { stat: 'damage', multiplier: 1.4, duration: 2 } },
    ]
  },
  stone_guardian: {
    name: 'Stone Guardian', icon: '🗿', color: '#78716c',
    baseHealth: 250, baseDamage: 20, baseDefense: 30, baseMana: 60,
    xpReward: 38, goldReward: 22, speed: 6,
    abilities: [
      { id: 'stone_fist', name: 'Stone Fist', icon: '👊', type: 'physical', damage: 1.2, description: 'A heavy fist of carved stone crushes down' },
      { id: 'petrify_gaze', name: 'Petrify Gaze', icon: '👁️', type: 'magical', damage: 0.6, cooldown: 5, description: 'Eyes glow and partially petrify a hero', effect: { type: 'stun', duration: 1 } },
      { id: 'quake_slam', name: 'Quake Slam', icon: '⛰️', type: 'physical', damage: 2.0, cooldown: 4, description: 'Slams the ground causing a localized earthquake' },
      { id: 'fortify', name: 'Fortify', icon: '🏰', type: 'buff', damage: 0, cooldown: 5, description: 'Channels ancient stone magic to harden its body', effect: { stat: 'defense', flat: 40, duration: 3 } },
      { id: 'crumble_curse', name: 'Crumble Curse', icon: '💀', type: 'magical', damage: 0.8, cooldown: 4, description: 'Curses a hero with decay, eroding their armor', effect: { type: 'dot', damage: 0.10, duration: 4 } },
    ]
  },
};
