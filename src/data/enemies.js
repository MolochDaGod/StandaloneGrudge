...
export const locations = [
  ...
  },
  {
    ...
    levelRange: [3, 5],
    enemies: ['goblin', 'skeleton', 'flying_eye', 'shadow_bat', 'mimic', 'mimic_chest', 'giant_fly'],
  ...
  },
  {
    ...
    levelRange: [7, 9],
    enemies: ['skeleton', 'goblin', 'orc', 'skeleton_knight', 'mimic', 'stone_guardian', 'water_priestess_mage', 'ice_elemental', 'mimic_chest'],
  ...
  },
  {
    ...
    levelRange: [15, 18],
    enemies: ['dark_mage', 'dragon_whelp', 'orc', 'skeleton_knight', 'crow_knight', 'imp', 'fire_worm'],
  ...
  },
  {
    ...
    levelRange: [16, 18],
    enemies: ['orc', 'dark_mage', 'dragon_whelp', 'stone_guardian', 'fire_elemental', 'fire_worm'],
