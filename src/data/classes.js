export const classDefinitions = {
  warrior: {
    ...
    abilities: [
      { id: 'slash', name: 'Slash', icon: '⚔️', description: 'A steady sword strike that restores resources', type: 'physical', damage: 0.9, manaCost: 0, staminaCost: 0, cooldown: 0, target: 'enemy', manaGain: 5, staminaGain: 8 },
  ...
  mage: {
    ...
    abilities: [
      { id: 'arcane_bolt', name: 'Arcane Bolt', icon: '✨', description: 'A focused arcane pulse that restores resources', type: 'magical', damage: 1.0, manaCost: 0, staminaCost: 0, cooldown: 0, target: 'enemy', manaGain: 8, staminaGain: 5 },
  ...
  worge: {
    ...
    abilities: [
      { id: 'mace_strike', name: 'Mace Strike', icon: '🔨', description: 'A storm-charged mace blow that restores resources', type: 'physical', damage: 1.0, manaCost: 0, staminaCost: 0, cooldown: 0, target: 'enemy', manaGain: 6, staminaGain: 6 },
  ...
  ranger: {
    ...
    abilities: [
      { id: 'quick_shot', name: 'Quick Shot', icon: '🏹', description: 'A swift arrow that restores resources', type: 'physical', damage: 0.8, manaCost: 0, staminaCost: 0, cooldown: 0, target: 'enemy', manaGain: 4, staminaGain: 7 },
