...
export const abilityEffectMap = {
  ...
  ranger: {
    ...
    'Poison Arrow': { effect: 'windBreath', beam: 'green', anim: 'attack2' },
...
export const weaponSkillEffectMap = {
  ...
  ws_envenom: { effect: 'windBreath', beam: 'green', anim: 'attack2' },
  ...
  ws_bow_poison: { effect: 'windBreath', beam: 'green', anim: 'attack1' },
