...
export const abilityEffectMap = {
  ...
  worge: {
    ...
    "Nature's Grasp": { effect: 'healEffect', beam: 'green', anim: 'heal' },
  ...
  ranger: {
    ...
    'Arrow Volley': { effect: 'thunderProjectile2', beam: 'green', anim: 'attack2', comboAnims: ['attack1', 'attack2', 'attack1'] },
...
export const weaponSkillEffectMap = {
  ...
  ws_whirlwind: { effect: 'fireExplosion2', beam: null, anim: 'attack2', comboAnims: ['attack1', 'attack2', 'attack3'] },
  ...
  ws_gs_whirlwind: { effect: 'slash', beam: null, anim: 'attack2', comboAnims: ['attack1', 'attack2', 'attack3'] },
  ...
  ws_staff_strike: { effect: 'holyImpact', beam: 'purple', anim: 'attack1' },
  ...
  ws_bow_shot: { effect: 'windProjectile', beam: 'green', anim: 'attack1' },
  ws_bow_aim: { effect: 'hitEffect1', beam: 'green', anim: 'attack2' },
  ws_bow_volley: { effect: 'thunderProjectile2', beam: 'green', anim: 'attack2', comboAnims: ['attack1', 'attack2', 'attack1'] },
  ...
  ws_gun_suppressive: { effect: 'thunderProjectile2', beam: null, anim: 'attack1', comboAnims: ['attack1', 'attack2', 'attack1'] },
  ws_wand_zap: { effect: 'holyImpact', beam: 'purple', anim: 'attack1' },
  ws_wand_flick: { effect: 'magicBubbles', beam: 'purple', anim: 'attack1' },
  ws_wand_chain: { effect: 'thunderHit', beam: 'orange', anim: 'attack2' },
  ws_wand_arcane_blast: { effect: 'magicSpell', beam: 'purple', anim: 'attack2' },
