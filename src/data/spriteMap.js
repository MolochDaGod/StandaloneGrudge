...
export const EFFECT_TYPE_TAGS = {
  cast: ['casting', 'magicSpell', 'magic8', 'protectionCircle', 'loading', 'beamHoly', 'holylight', 'holyheal'],
  effect: ['arcaneslash', 'arcanebolt', 'arcanemist', 'arcanelighting', 'flamestrike', 'frostbolt', 'frozenIce', 'healingwave', 'healingregen', 'hitBurst', 'critSlash'],
  effect2: ['effect1', 'effect2', 'effect3', 'effect4', 'smearH1', 'smearH2', 'smearH3', 'smearV1', 'smearV2', 'smearV3'],
  effect3: ['earthBump', 'earthWall', 'waterSpike', 'waterSplash', 'waterStartup1', 'waterStartup2', 'waterBall', 'waterBallImpact', 'waterBlast', 'waterBlastEnd'],
  impact: ['weaponHit', 'hitEffect1', 'hitEffect2', 'hitEffect3', 'thunderHit', 'holyImpact', 'impactFireA', 'impactFireB', 'impactFireC', 'impactFireD', 'impactRedA', 'impactRedB', 'impactOrangeA', 'impactOrangeB', 'impactYellowA', 'impactYellowB', 'impactBlueA', 'impactBlueB', 'impactCyanA', 'impactCyanB', 'impactGreenA', 'impactGreenB', 'impactPurpleA', 'impactPurpleB', 'impactPurpleC', 'impactPurpleD', 'impactPinkA', 'impactPinkB', 'impactMagentaA', 'impactMagentaB', 'impactWhiteA', 'impactWhiteB', 'impactWhiteC', 'impactWhiteD', 'impactTealA', 'impactTealB'],
  projectile: ['thunderProjectile', 'thunderProjectile2', 'windProjectile', 'firebolt', 'fireBreath', 'fireBreathHit', 'bulletImpactBlue', 'bulletImpactGreen', 'bulletImpactPurple', 'bulletImpactRed', 'bulletImpactYellow'],
  traveleffect: ['windBreath', 'thrust1', 'thrust2', 'smokeVfx1', 'smokeVfx2', 'smokeVfx3'],
  aura: ['brightFire', 'fire', 'fireSpin', 'nebula', 'sunburn', 'phantom', 'vortex'],
  animation: ['magickaHit', 'flameLash', 'blueFire', 'felSpell', 'midnight', 'freezing', 'magicBubbles'],
  animation2: ['demonSlash1', 'demonSlash2', 'demonSlash3', 'fireExplosion', 'fireExplosion2', 'slash', 'slashRanged'],
  buff: ['healingregen', 'holyheal', 'holylight', 'holyVfx', 'healEffect', 'resurrect', 'beamHoly', 'healingwave', 'protectionCircle'],
  debuff: ['frozenIce', 'frostbolt', 'arcanemist', 'midnight', 'felSpell', 'smokeVfx2'],
  stone: ['earthBump', 'earthWall'],
  frozen: ['frozenIce', 'frostbolt', 'iceVfx1', 'iceVfx2', 'iceHit', 'iceRepeatable', 'iceStart', 'iceActive', 'iceVfx2Start', 'iceEnding', 'freezing'],
  slow: ['magicBubbles', 'smokeVfx2', 'iceActive'],
  haste: ['windBreath', 'windProjectile', 'windHit'],
  dodge: ['smokeVfx1', 'smokeVfx3', 'windBreath'],
  block: ['protectionCircle', 'holyRepeatable'],
  crit: ['critSlash', 'hitBurst'],
  spellcrit: ['arcaneslash', 'arcanelighting', 'arcanebolt'],
  largecrit: ['flamestrike', 'fireExplosion', 'arcanelighting'],
  combo: ['critSlash', 'hitBurst', 'arcaneslash', 'impactFireA', 'impactRedA'],
  counter: ['slash', 'hitEffect1', 'weaponHit'],
  huechange: ['arcanemist', 'arcanebolt', 'arcanelighting', 'flamestrike', 'frostbolt', 'healingwave'],
  transform: ['beamHoly', 'holylight', 'arcanemist', 'brightFire'],
  sleep: ['smokeVfx2', 'arcanemist', 'magicBubbles'],
