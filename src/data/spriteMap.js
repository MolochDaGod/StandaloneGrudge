...
export const abilityEffectMap = {
  ...
  mage: {
    ...
    'Meteor Strike': { effect: 'flamestrike', beam: 'red', anim: 'attack2', followUp: [{ effect: 'fireExplosion2', delay: 200 }, { effect: 'hitBurst', delay: 450, filter: 'saturate(2)' }] },
    ...
    'Arcane Cataclysm': { effect: 'arcanelighting', beam: 'purple', anim: 'attack2', followUp: [{ effect: 'arcanebolt', delay: 200, filter: 'saturate(2)' }, { effect: 'arcanemist', delay: 400 }, { effect: 'effect1', delay: 600, filter: 'hue-rotate(270deg)' }] },
  },
  worge: {
  ...
  ranger: {
    ...
    'Wind Walk': { effect: 'windBreath', beam: null, anim: 'block', followUp: [{ effect: 'windProjectile', delay: 200 }, { effect: 'smokeVfx1', delay: 400, filter: 'hue-rotate(90deg) brightness(1.3)' }] },
...
export const weaponSkillEffectMap = {
  ...
  ws_shield_charge: { effect: 'thrust1', beam: null, anim: 'attack3', followUp: [{ effect: 'earthBump', delay: 150 }, { effect: 'smokeVfx1', delay: 380 }] },
