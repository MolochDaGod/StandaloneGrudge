...
const spriteSheets = {
  ...
  'greatsword-skeleton': {
    ...
    attack1: { src: '/sprites/greatsword-skeleton/attack1.png', frames: 6 },
    attack2: { src: '/sprites/greatsword-skeleton/attack2.png', frames: 6 },
...
export const raceClassSpriteMap = {
  ...
  orc: {
    ...
    ranger: { ...spriteSheets['elite-orc'], filter: 'brightness(0.8) saturate(1.5) hue-rotate(-15deg)' },
  },
  elf: {
  ...
  undead: {
    ...
    ranger: spriteSheets['armored-skeleton'],
  },
  barbarian: {
