...
export const enemyAbilityEffects = {
  'Shadow Bolt': { effect: 'arcanebolt', beam: 'purple' },
  'Dark Nova': { effect: 'arcanemist', beam: 'purple' },
  'Drain Life': { effect: 'arcanelighting', beam: 'purple' },
  'Fire Breath': { effect: 'flamestrike', beam: 'orange' },
  'Hellfire': { effect: 'flamestrike', beam: 'orange' },
  'Meteor': { effect: 'flamestrike', beam: 'red' },
  'Soul Bolt': { effect: 'arcanebolt', beam: 'purple' },
  'Death Coil': { effect: 'arcaneslash', beam: 'purple' },
...
export const abilityEffectMap = {
  warrior: {
    'Slash': { effect: 'critSlash', beam: null, anim: 'attack1' },
    'Power Strike': { effect: 'hitBurst', beam: null, anim: 'attack3' },
    'War Cry': { effect: 'beamHoly', beam: null, anim: 'cast' },
    'Shield Bash': { effect: 'hitBurst', beam: null, anim: 'block' },
    'Cleave': { effect: 'arcaneslash', beam: null, anim: 'attack2', comboAnims: ['attack1', 'attack2', 'attack3'] },
    'Demon Blade': { effect: 'demonSlash3', beam: 'blue', anim: 'attack3' },
    'Invincible': { effect: 'beamHoly', beam: null, anim: 'cast' },
  },
  mage: {
    'Arcane Bolt': { effect: 'arcanebolt', beam: 'purple', anim: 'attack1' },
    'Fireball': { effect: 'flamestrike', beam: 'orange', anim: 'attack1' },
    'Divine Heal': { effect: 'holyheal', beam: null, anim: 'heal', postHealEffect: 'healingregen' },
    'Ice Storm': { effect: 'frostbolt', beam: 'purple', anim: 'attack2', isIceStorm: true },
    'Mana Shield': { effect: 'arcanemist', beam: null, anim: 'block' },
  },
  worge: {
  ...
  ranger: {
    ...
    'Aimed Shot': { effect: 'hitBurst', beam: 'red', anim: 'attack2' },
    'Poison Arrow': { effect: 'healingregen', beam: 'green', anim: 'attack2', effectFilter: 'hue-rotate(90deg) saturate(2)' },
    'Evasive Roll': { effect: 'windBreath', beam: null, anim: 'block', followUp: [{ effect: 'windProjectile', delay: 350 }, { effect: 'windHit', delay: 600 }] },
    'Arrow Volley': { effect: 'critSlash', beam: 'green', anim: 'attack2', comboAnims: ['attack1', 'attack2', 'attack1'] },
    'Focus': { effect: 'beamHoly', beam: null, anim: 'block' },
  },
};
...
export const weaponSkillEffectMap = {
  ...
  ws_staff_strike: { effect: 'arcanebolt', beam: 'purple', anim: 'attack1' },
  ws_staff_pulse: { effect: 'arcanemist', beam: 'purple', anim: 'attack1' },
  ws_staff_nova: { effect: 'arcanelighting', beam: 'purple', anim: 'attack2' },
  ws_staff_barrier: { effect: 'arcanemist', beam: null, anim: 'block' },
  ws_staff_drain: { effect: 'arcanelighting', beam: 'purple', anim: 'attack2' },
  ...
  ws_wand_zap: { effect: 'arcaneslash', beam: 'purple', anim: 'attack1' },
  ws_wand_flick: { effect: 'arcanemist', beam: 'purple', anim: 'attack1' },
  ws_wand_chain: { effect: 'arcanelighting', beam: 'orange', anim: 'attack2' },
  ws_wand_arcane_blast: { effect: 'arcanebolt', beam: 'purple', anim: 'attack2' },
  ws_wand_dispel: { effect: 'holylight', beam: null, anim: 'block' },
